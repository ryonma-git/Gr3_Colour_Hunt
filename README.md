...
5. **0.8秒つづけて**外れたら「さがし中」に戻る（別のものを探し直せる。
   シャッターを押すときの手ぶれで緑が消えないよう、みつけるより少し長め）

円の中の平均ではなく、**中央のごく狭い一点だけ**を見ます。背景の影響を避けるためです。

あたらしい色になるたび（START / つぎをさがす）に、その色の名前を**英語で1回読み上げます**。
画面上の色の名前をタップすれば、何度でも聞き直せます。

## 2つの遊びかた（Swift Playgrounds 版）

| | 内容 |
|---|---|
| **SOLO HUNT** | 7色からランダムに1色。ひとりで、みつけたら次の色へ |
| **TEAM HUNT** | 班（1〜8）ごとに担当色が固定。5分間で担当色のものをできるだけ多く撮る。おわると RESULT 画面 |
